...
const Product = React.memo(({ name, products, banner }) => {
                        ...
                        {filterTabs.map((tab) => (
                            <button
                                ...
                                className={`relative transition-all duration-300 pb-1 ${
                                    activeFilter === tab ? "text-amber-600" : "hover:text-amber-500"
                                }`}
                            >
                                {tab}
                                {activeFilter === tab && (
                    ...
                    <AnimatePresence mode="popLayout">
                        {filteredProducts.map((product) => (
                            <motion.div
                                ...
                                className="flex flex-col group p-3 bg-white border border-gray-100 shadow-lg hover:shadow-2xl rounded-2xl transition-all duration-300"
                            >
                                <div className="relative overflow-hidden mb-4 rounded-xl bg-gray-50 flex items-center justify-center aspect-square">
                                    ...
                                    <div className="absolute top-1/2 right-3 -translate-y-1/2 flex flex-col gap-3 transform translate-x-16 group-hover:translate-x-0 opacity-0 group-hover:opacity-100 transition-all duration-300">
                                        <motion.button
