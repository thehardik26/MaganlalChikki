        ...
        <div className="bg-white py-12 px-4 md:px-10 lg:px-12 font-sans overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto mt-10 flex flex-col lg:flex-row items-start gap-12">
                <motion.div
                    ...
                    className="w-full lg:w-[30%] relative flex flex-col items-center"
                >
                    <motion.div
                        initial={{ rotate: -15, scale: 0.8 }}
                        animate={{ scale: 1 }}
                        className="absolute -top-10 left-0 bg-amber-500 text-white rounded-full w-24 h-24 flex items-center justify-center text-center text-[11px] font-black leading-tight rotate-[-15deg] z-20 p-2 shadow-xl border-4 border-white"
                    >
                        Try our <br /> Tasty
                    </motion.div>

                    <h2 className="text-amber-600 text-5xl font-serif italic mt-10 mb-8 text-center leading-tight tracking-tight">
                        {name || "Special Chikki"}
                    </h2>
                    ...
                    >
                        <div className="w-72 h-72 md:w-85 md:h-85 rounded-full border-8 border-dashed border-amber-100 p-3 animate-[spin_60s_linear_infinite] group-hover:pause"></div>
