                    ...
                    <div className="flex flex-1 items-center justify-end gap-2 sm:gap-4">
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            >
                                ...
                                {favItems?.length > 0 && (
                                    <span className="absolute top-1 right-0.5 bg-amber-500 text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full border-2 border-white animate-in fade-in zoom-in">
                                        {favItems.length}
                                    </span>
                                )}
                            </NavLink>
                            ...
                            <Menu as="div" className="relative ml-2 sm:ml-4">
                                ...
                                <MenuItems className="absolute right-0 z-10 mt-3 w-48 origin-top-right rounded-xl bg-white border border-gray-100 p-1 shadow-xl ring-0 focus:outline-none">
                                    <MenuItem>
